/**
 * Código criado e publicado por Rob Camick no blog "Java Tips Weblog"
 * https://tips4java.wordpress.com/2009/05/23/text-component-line-number/
 */

package fatec.alg.gui.componente;
 ...
 * a JScrollPane.
 * @author Rob Camick (https://tips4java.wordpress.com/2009/05/23/text-component-line-number/)
 */
public class TextLineNumber extends JPanel
    ...
    private Color otherLineForeground;
    ...
    public TextLineNumber(JTextComponent component, int minimumDisplayDigits) {
        ...
        setOtherLineForeground(Color.GRAY);
     ...
     * @return the Color used to render the current line number
     */
    public Color getOtherLineForeground() {
        return otherLineForeground == null ? getForeground() : otherLineForeground;
    }

    /**
     * The Color used to render the current line digits. Default is Coolor.RED.
     *
     * @param otherLineForeground the Color used to render the current line
     */
    public void setOtherLineForeground(Color otherLineForeground) {
        this.otherLineForeground = otherLineForeground;
    }
     ...
     * </ul>
     * @param digitAlignment Digit Alignment
     */
        ...
        while (rowStartOffset <= endOffset) {
            try {
                if (isCurrentLine(rowStartOffset)) {
                    ...
                    g.setColor(getOtherLineForeground());
                }
