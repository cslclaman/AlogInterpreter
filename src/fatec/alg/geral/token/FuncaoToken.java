...
/**
 * Classe de enumeração de funções de tokens.
 * A função de um token indica se o token identifica uma variável, uma operação,
 * uma rotina, é uma constante ou palavra reservada, etc.
 * Todas as análises de tokens são realizadas a partir desta função.
 * @author Caique
 */
